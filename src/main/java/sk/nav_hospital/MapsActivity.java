...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        while (res.moveToNext()) {
                            buffer.append("hospital_name" + res.getString(0) + "\n");
    ...
    public void sendinfo(String g) {
        Intent intent = new Intent(this, InformActivity.class);
        intent.putExtra("place_name", g);
...
//        mMap.animateCamera(CameraUpdateFactory.zoomBy(5));
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.B_hopistals:
                ...
                Log.d("Toast", "Showing Nearby Hospitals: ");
                break;
        }
    }
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace) {
        ...
        googlePlaceUrl.append("&key=" + "AIzaSyCMaZJPSw6T-iGUKinhE3GzWimhD-RDrpY");
